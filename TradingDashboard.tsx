...
import { Activity, Wallet, RefreshCcw, Database, Brain, Trophy, ArrowLeft, Layers, Home } from 'lucide-react';
      ...
      <header className="border-b border-gray-800 bg-gray-900/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-[1920px] mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <button 
              onClick={goToLanding}
              className="p-2 -ml-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded transition-colors"
              title="Back to Home"
            >
              <ArrowLeft size={20} />
            </button>
